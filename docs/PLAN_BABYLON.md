...
- **HUD layout defaults (presentation):** `#hudBottomLeft` flex column — chat / loadout chips / self+keybind hint non-overlapping vs bottom-center hotbar at 1280×720 under #39 fog; `?ve=hud-layout` (user-attachments VE)
